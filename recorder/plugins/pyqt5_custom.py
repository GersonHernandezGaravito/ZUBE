# -*- Coding: utf-8 -*-
from PyQt5.QtWidgets import QMainWindow, QWidget, QAction, QMenu, QMessageBox, QLineEdit, QPushButton, QGroupBox, QVBoxLayout, QLabel, QTableWidget, QTableWidgetItem, QGridLayout, QFormLayout, QHBoxLayout, QPlainTextEdit
...
class ButtonCustom(QPushButton):
    ...
    def updateButton(self, path_icon=None):
        self.sender().setIcon(QIcon(path_icon))
        self.sender().setIconSize(QSize(20,20))
